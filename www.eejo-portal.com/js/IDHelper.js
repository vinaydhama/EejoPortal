...
{
    html2canvas(document.getElementById(idcardplaceholder)).then(canvas => {
...
function UpdateEventID(userinfo,datatopost, ParentContainer) {
  ...
  document.getElementById("RegTime").innerText = formatDateManually(now);
